...
An :class:`ScmEnvironment` plugin wraps an SCM tool (e.g. Git) and
...
class ScmEnvironment(ToolBasedPlugin):
    ...
    Subclasses **must** override :meth:`tool_name`, :meth:`clone`,
    and :meth:`is_cloned`.
    """
    ...
    def tool_name(cls) -> str:
        ...
        by :meth:`clone_command` to build the default command.
        """
        ...
    ...
    def clone_command(self, url: str, destination: Path) -> list[str]:
        ...
        Built from :meth:`tool_name` and the provided URL/destination.
